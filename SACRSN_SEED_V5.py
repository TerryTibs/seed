# ==============================================================================
# SACRSN-SEED IMMORTAL CORE — THE UNIFIED EDITION (v5)
# ==============================================================================
#
# STATUS:  AUDITED × 4 · FIXED × 4 · ALL FEATURES WIRED · ALL ISSUES RESOLVED
#
# AUDIT PASS 4 FIXES (from SACRSN_SEED_V4.py audit):
#  [MEDIUM]   world_env GRU state now saved/restored around rollout() in phase_train
        ...
        for i, (model, opt) in enumerate(zip(self.pop, self.opts)):
            ...
            for step in range(CONFIG["CYCLES_PER_GEN"]):
                ...
                if self.prev_loss is not None:
                    # [FIX LOW] Skip meta update when prev_loss is None (step 0)
                    # — prev_loss=0.0 would signal loss "jumped from perfect", biasing meta
